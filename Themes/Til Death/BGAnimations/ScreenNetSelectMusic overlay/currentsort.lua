...
t[#t+1] = LoadFont("Common Large") .. {
	InitCommand=cmd(xy,frameX,frameY+430;halign,1;zoom,0.50;maxwidth,(frameWidth-40)/0.35);
...
--Disabling it because it cause unneeded error. It's detecting to see if Screen select music is matched for the music wheel. -Misterkister
