...
t[#t+1] = LoadFont("Common Large")..{
	InitCommand=cmd(xy,5,32;halign,0;valign,1;zoom,0.55;diffuse,getMainColor('highlight');settext,"Netplay Room";);
}
t[#t+1] = LoadActor("../_cursor");
t[#t+1] = LoadActor("../_halppls");
t[#t+1] = LoadActor("currenttime");
t[#t+1] = LoadActor("searchbar");
t[#t+1] = LoadActor("../ScreenNetSelectMusic decorations/netplayBPMDisplay");
t[#t+1] = LoadActor("../ScreenNetSelectMusic decorations/somethingelseBPMLabel");
